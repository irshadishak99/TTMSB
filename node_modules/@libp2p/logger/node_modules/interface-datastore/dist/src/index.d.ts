...
import type { Await, AwaitIterable, Store, AbortOptions } from 'interface-store';
...
export interface Datastore<HasOptionsExtension = unknown, PutOptionsExtension = unknown, PutManyOptionsExtension = unknown, GetOptionsExtension = unknown, GetManyOptionsExtension = unknown, DeleteOptionsExtension = unknown, DeleteManyOptionsExtension = unknown, QueryOptionsExtension = unknown, QueryKeysOptionsExtension = unknown, BatchOptionsExtension = unknown> extends Store<Key, Uint8Array, Pair, HasOptionsExtension, PutOptionsExtension, PutManyOptionsExtension, GetOptionsExtension, GetManyOptionsExtension, DeleteOptionsExtension, DeleteManyOptionsExtension> {
    /**
